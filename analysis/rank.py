...
CHECKPOINT_PATH = "/home/ahnjm/aioptim_adalora/Adaptive-Rank-for-LoRA/outputs_qnli/adalora_small/best"
# ==========================================
...
#     """
#     파라미터 이름에서 layer index와 논문 표기(W_q, W_k, ...)를 뽑는 헬퍼.
#     BART 모델의 명명 규칙을 지원하도록 수정.
#     """
#     # layer index
#     # BART는 'encoder.layers.X' 또는 'decoder.layers.X' 구조를 가짐.
...
#     # Attention Projections (W_q, W_k, W_v) - BART 스타일 이름
#     if "q_proj" in name:
#         module_type = "$W_q$"
#     elif "k_proj" in name:
#         module_type = "$W_k$"
...
#     # Attention Output Projection (W_o) - BART 스타일 이름
#     elif "out_proj" in name:
#         module_type = "$W_o$"
        
#     # Feed-Forward Network Projections (W_f1, W_f2) - BART 스타일 이름
#     elif "fc1" in name:
#         module_type = "$W_{f1}$"
#     elif "fc2" in name:
#         module_type = "$W_{f2}$"
...
def main():
    ...
    base_model = AutoModelForSequenceClassification.from_pretrained(
        "/home/ahnjm/aioptim_adalora/Adaptive-Rank-for-LoRA/outputs_qnli_original/tmp_fp_init_deberta_qnli",
        num_labels=2,
    ...
    output_path = os.path.join(output_dir, "adalora_small_rank_heatmap.png")
